          ...
          axios
            ...
            .then((res) => {
              ...
              axios
                ...
                .then((res) => {
                  const newDataTags = res.data;
                  const qtRelationship = [];
                  qtRelationship.push(insertId);
                  newDataTags.forEach((tagObject) => {
                    if (tags.includes(tagObject.name)) {
                      qtRelationship.push(tagObject.tid);
                    }
                  });
                  axios
                    .post("http://localhost:8000/newqt", qtRelationship)
                    .then((res) => {
                      const error = {
                        value: false,
                        errors: "",
